package com.videojs.mux.m2ts {
  ...
  var StreamTypes:Object = {
    H264_STREAM_TYPE: 0x1B,
    ADTS_STREAM_TYPE: 0x0F,
    METADATA_STREAM_TYPE: 0x15
  };

  var MP2T_PACKET_LENGTH:int = 188; // bytes
  // TODO int?
  var SYNC_BYTE:int = 0x47;
  ...
  public class TransportPacketStream extends Stream {
    // TODO Uint8Array
    private buffer:ByteArray = new ByteArray(MP2T_PACKET_LENGTH);
   ...
   // TODO ByteArray?
    public function push(bytes:ByteArray):void {
      ...
      var endIndex:int = MP2T_PACKET_LENGTH;
      // TODO Uint8Array
  ...
  public class TransportParseStream extends Stream {
    ...
    public var STREAM_TYPES:Object = {
      h264: 0x1b,
      adts: 0x0f
    };
